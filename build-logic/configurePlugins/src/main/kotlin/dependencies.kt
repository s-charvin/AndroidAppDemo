...
object Versions {
    ...
    const val androidxWindowManager = "1.3.0-alpha03"
...
object Libraries {
    ...
    const val androidxWindowCore = "androidx.window:window-core:${Versions.androidxWindowManager}"
...
object Plugins {
    const val androidApplication = "com.android.application:${Versions.androidGradlePlugin}"
    const val androidLibrary = "com.android.library:${Versions.androidGradlePlugin}"
    const val androidTest = "com.android.test:${Versions.androidGradlePlugin}"
    const val baselineProfile = "androidx.baselineprofile:${Versions.androidxMacroBenchmark}"
    const val compose = "org.jetbrains.kotlin.plugin.compose:${Versions.kotlin}"
    const val dependencyGuard = "com.dropbox.dependency-guard:${Versions.dependencyGuard}"
    const val firebaseCrashlytics = "com.google.firebase.crashlytics:${Versions.firebaseCrashlyticsPlugin}"
    const val firebasePerf = "com.google.firebase.firebase-perf:${Versions.firebasePerfPlugin}"
    ...
    const val ksp = "com.google.devtools.ksp:${Versions.ksp}"
    const val moduleGraph = "com.jraska.module.graph.assertion:${Versions.moduleGraph}"
    const val protobuf = "com.google.protobuf:${Versions.protobufPlugin}"
    const val roborazzi = "io.github.takahirom.roborazzi:${Versions.roborazzi}"
    const val roomGradlePlugin = "androidx.room:room-gradle-plugin:${Versions.room}"
    const val secrets = "com.google.android.libraries.mapsplatform.secrets-gradle-plugin:${Versions.secrets}"


    // Plugins defined by this project
    const val android_application = "myapp.android.application"
    const val android_application_compose = "nowinandroid.android.application.compose"
}
